    ...
    <div>
      {
        ListadoFechas?.map((item, index) => {
          if (item.Encuesta) {
            return (
              <div key={index} className="border text-left flex-row flex rounded-xl mt-2 cursor-pointer hover:opacity-60 hover:bg-gray-500 border-green-400">
            ...
            return (
              <div key={index} className="border text-left flex-row flex rounded-xl mt-2 cursor-pointer hover:opacity-60 hover:bg-gray-500 border-violet-500 bg-slate-800">
            ...
            return (
              <div key={index} className="border text-left flex-row flex rounded-xl mt-2 cursor-not-allowed border-red-600 bg-slate-800">
